...
export default function Expandable(props) {
    const {wrapperClass, contentClass, children, isOpen, updateHeight, minHeight=0, onOverflow} = props;
    const contentRef = useRef(null);
    const [maxHeight, setMaxHeight] = useState(MAX_HEGHT_DEFAULT);
    const containerMaxHeight = isOpen ? maxHeight : updateHeight ? getMaxHeight(contentRef) :  minHeight;
    ...
    return (
        <div
            ...
            style={{maxHeight: containerMaxHeight, opacity: (isOpen || updateHeight) ? 1 : minHeight}}
        >
